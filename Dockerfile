...
COPY . .
# Ajouter le contenu du fichier JSON en tant que variable d'environnement (ou fichier temporaire)
# Le contenu du fichier `service-account-key.json` doit être inséré ici
RUN echo '{
